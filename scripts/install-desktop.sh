#!/usr/bin/env bash
# dsh-readonly-security-audit — one-shot installer for DeepSeek Harness Desktop
#
...
# ---- per-plugin config ------------------------------------------------------
REPO="my-dsh-plugin/readonly-security-audit"
BRANCH="main"
PLUGIN_NAME="dsh-readonly-security-audit"
WHITELIST_NS=""   # no settings namespace; allowlist patch skipped
